...
int look_string(string t, string p){
...
int main()
{
    ...
    int query;
    cout<<"Hello user enter how many patterns you need to search:... ";
    cin>>query; getchar();

    while(query--){
        cout<<"Please enter pattern as your wish....: ";
        getline(cin, p);
